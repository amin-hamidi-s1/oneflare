export const SCENARIOS = [
  {
    ...
    target: "shop.soledrop.co /search",
...
| limit 100`,
  ...
  },
  {
    ...
    severity: "High",
    cfProduct: "WAF / Firewall Rules",
    target: "shop.soledrop.co /search, /reviews",
...
| limit 100`,
  ...
  },
  {
    ...
    severity: "Medium",
    cfProduct: "WAF / Firewall Rules",
    target: "shop.soledrop.co /products, /search?file=",
...
| limit 100`,
  ...
  },
  {
    ...
    target: "shop.soledrop.co /api/v1/customers/export",
...
| limit 100`,
  ...
  },
  {
    ...
    target: "shop.soledrop.co /api/v1/*",
...
| limit 100`,
  ...
  },
  {
    ...
    target: "shop.soledrop.co /api/v1/chat",
...
| limit 100`,
  ...
  },
  {
    ...
    target: "Cloudflare Gateway DNS (DoH)",
